...
const appCacheName = 'Panel Material UI-1.6.2b1';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.6.2-b.1/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
