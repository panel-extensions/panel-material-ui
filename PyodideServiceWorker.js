...
const appCacheName = 'Panel Material UI-0.5.1';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.8.2-rc.1/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
