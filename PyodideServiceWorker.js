...
const appCacheName = 'Panel Material UI-0.12.0';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.9.3/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
