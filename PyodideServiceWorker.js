...
const appCacheName = 'Panel Material UI-0.4.0';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.8.0-a.1/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
