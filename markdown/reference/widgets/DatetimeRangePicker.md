...
The `size` parameter allows you to control the visual size and density of the `DatetimeRangePicker` input fields. Choose from "small", "medium" (default), or "large":


```python
pmui.FlexBox(
    pmui.DatetimeRangePicker(label='Small', value=(dt.datetime(2024, 4, 1, 9, 0), dt.datetime(2024, 4, 15, 17, 0)), size='small'),
    pmui.DatetimeRangePicker(label='Medium', value=(dt.datetime(2024, 4, 1, 9, 0), dt.datetime(2024, 4, 15, 17, 0)), size='medium'),
    pmui.DatetimeRangePicker(label='Large', value=(dt.datetime(2024, 4, 1, 9, 0), dt.datetime(2024, 4, 15, 17, 0)), size='large'),
)
```
