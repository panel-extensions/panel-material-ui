...
- **`size`** (str, default="medium"): Controls the visual size/density of the date range picker input fields. One of "small", "medium", or "large".
...
```python
pmui.DateRangePicker(label='Period', helper_text='Select start and end dates')
```
...
The `size` parameter allows you to control the visual size and density of the `DateRangePicker` input fields. Choose from "small", "medium" (default), or "large":


```python
pmui.FlexBox(
    pmui.DateRangePicker(label='Small', value=(dt.date(2024, 4, 1), dt.date(2024, 4, 15)), size='small'),
    pmui.DateRangePicker(label='Medium', value=(dt.date(2024, 4, 1), dt.date(2024, 4, 15)), size='medium'),
    pmui.DateRangePicker(label='Large', value=(dt.date(2024, 4, 1), dt.date(2024, 4, 15)), size='large'),
)
```
