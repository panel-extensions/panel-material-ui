...
class Badge(MaterialComponent, SizingModeMixin):
    """
    ...
    - https://panel-material-ui.holoviz.org/reference/layouts/Badge.html
    ...
    invisible = param.Boolean(default=False, doc="""
        Whether the badge is invisible.""")

    margin = Margin(default=0, doc="""
        The margin around the badge wrapper.""")
